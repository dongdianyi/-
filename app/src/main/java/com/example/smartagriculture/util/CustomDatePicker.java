...
public class CustomDatePicker {
    ...
    private void initView() {
        year_pv = datePickerDialog.findViewById(R.id.mmv_year);
        month_pv = datePickerDialog.findViewById(R.id.mmv_month);
        day_pv = datePickerDialog.findViewById(R.id.mmv_day);
        hour_pv = datePickerDialog.findViewById(R.id.mmv_hour);
        minute_pv = datePickerDialog.findViewById(R.id.mmv_minute);
