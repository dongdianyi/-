            ...
            when (flag) {
                STOCK -> {
                    if (rootView.radioGroup.checkedRadioButtonId==R.id.radioButton) {
                        nav(activity,R.id.stock_constraint).navigate(R.id.action_mainFragment_to_stockFragment)
                    }else{
                        nav(activity,R.id.stock_constraint).navigate(R.id.action_mainFragment_to_productFragment)
                    }
                }
                else -> {
                }
