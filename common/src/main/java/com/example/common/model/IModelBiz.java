...
public interface IModelBiz {
     void getHttp(Map header,String flag, String url, Map mapParameter, OnDialogGetListener onDialogGetListener);
     void getHttp(Map header,String flag, String url, OnDialogGetListener onDialogGetListener);
